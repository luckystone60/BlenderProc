# blenderproc run examples/datasets/front_3d/save_scene.py /srv/02-data/02-3D_model/01-3DFront/3D-FRONT/c7454293-6e55-460a-accc-039ec046435b.json /srv/02-data/02-3D_model/01-3DFront/3D-FUTURE-model /srv/02-data/02-3D_model/01-3DFront/3D-FRONT-texture/ /srv/02-data/01-stereo_by_blender/01-scenes
...
out_filename = os.path.join(args.output_dir, filename.replace('json', 'blend'))
